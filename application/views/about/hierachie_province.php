<section class="nav_current">
	<div class="container">
		<p>
			Mandataires au niveau provincial
		</p>
	</div>
</section>
<section class="apropos_ecc">
	...
	<div class="container">
		<h3 class="text-center">Responsables au niveau provincial</h3><hr>

		<div class="row">
			<?php
				$query = $this->hierachie->getProvinceHierachie();
				...
				<div class="card border-dark mb-3">
				  	...
				  	<div class="card-body text-dark">
					    ...
					    <h6 class="text-center text-muted">
					    	<strong><?php echo strtoupper('president provincial'); ?></strong>
					    </h6><hr>
